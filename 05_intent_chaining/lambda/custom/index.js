...
const RegisterBirthdayIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (intent.confirmationStatus === 'CONFIRMED') {
            ...
            const month = monthSlot.resolutions ? monthSlot.resolutions.resolutionsPerAuthority[0].values[0].value.id : sessionAttributes['month']; //MM
...
const RegisterBirthdayTodayIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'RegisterBirthdayTodayIntent';
    },
    handle(handlerInput) {
        const {attributesManager, requestEnvelope} = handlerInput;
        const sessionAttributes = attributesManager.getSessionAttributes();
...
exports.handler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        ...
        RegisterBirthdayTodayIntentHandler,
    ...
    .withCustomUserAgent('sample/happy-birthday/mod5b')
    .lambda();